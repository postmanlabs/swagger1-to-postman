...
const validator = require('postman_validator');
...
var converter = {
  ...
  convertJSON: function (inputJson, options, cb, cbError) {
    try {
      this.sampleFile = JSON.parse('{"environment":{"values": [],"name": "","id": "","timestamp": 0},' +
        '"folders": [{"id": "","name": "","description": "","order": [],"collection_name": "","collection_id": ""}],' +
        '"id": "","name": "Postman Barebones","order": [],"requests": [{"collectionId": "","dataMode": "params",' +
        '"descriptionFormat": "html","description": "","data": [],"headers": "","id": "","method": "","name": "",' +
        '"preRequestScript": "","pathVariables": {},"responses": [],"synced": false,"tests": "",' +
        '"time": 0,"url": ""}],"synced": false,"timestamp": 0}');
